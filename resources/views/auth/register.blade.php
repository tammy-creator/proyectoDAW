@extends('layouts.main', ['class' => 'off-canvas-sidebar', 'activePage' => 'register', 'title' => __('Centro Proyecta')])
          ...
          <div class="card-body ">
            ...
            <div class="bmd-form-group{{ $errors->has('apellidos') ? ' has-danger' : '' }}  mt-3">
              <div class="input-group">
                ...
                <input type="text" name="apellidos" class="form-control" placeholder="{{ __('Apellidos...') }}" value="{{ old('apellidos') }}" required autocomplete="apellidos">
              </div>
            ...
            <div class="bmd-form-group{{ $errors->has('direccion') ? ' has-danger' : '' }}  mt-3">
              <div class="input-group">
                ...
                <input type="text" name="direccion" class="form-control" placeholder="{{ __('Dirección...') }}" value="{{ old('direccion') }}" required autocomplete="direccion">
              </div>
            ...
            <div class="bmd-form-group{{ $errors->has('telefono') ? ' has-danger' : '' }}  mt-3">
              <div class="input-group">
                ...
                <input type="text" name="telefono" class="form-control" placeholder="{{ __('Teléfono...') }}" value="{{ old('telefono') }}" required autocomplete="telefono">
              </div>
            ...
            <div class="bmd-form-group{{ $errors->has('password_confirmation') ? ' has-danger' : '' }} mt-3">
              <div class="input-group">
                ...
                <input type="password" name="password_confirmation" id="password_confirmation" class="form-control" placeholder="{{ __('Confirma Password...') }}" required autocomplete="new-password">
              </div>
